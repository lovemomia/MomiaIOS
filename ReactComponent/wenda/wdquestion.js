...
class WDQuestionComponent extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return this.state.isLoading ? (<View style={[SGStyles.container, styles.loadingContainer]}><ActivityIndicatorIOS
      ...
      <TouchableHighlight onPress={() => this._rowPressed(rowData)}
        underlayColor='#dddddd'><Text style={{height:60}}>向专家提问</Text></TouchableHighlight>
      </View>
  }
...
ReactNative.AppRegistry.registerComponent('WDQuestionComponent', () => WDQuestionComponent);